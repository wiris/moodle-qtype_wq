...
a.wirishelp {
    background: url("?service=resource&name=manual.png&v=3.70.1") no-repeat scroll left top transparent;
    display: block;
    height: 17px;
    margin: 0;
    width: 17px;
...
span.wirisloading {
    background: url("?service=resource&name=loading.gif&v=3.70.1") no-repeat scroll left top transparent;
    display: inline-block;
    height: 16px;
    width: 16px;
    margin: 0;
...
div.wiristabs fieldset.wirisfieldset legend a.wiriscollapsed {
    background: url("?service=resource&name=fieldset-collapsed.png&v=3.70.1") no-repeat 3px 50%;
    padding-left: 14px;
}
div.wiristabs fieldset.wirisfieldset legend a.wirisexpanded {
    background: url("?service=resource&name=fieldset-expanded.png&v=3.70.1") no-repeat 3px 50%;
    padding-left: 14px;
}
...
div.wirismessage.wiriserror {
    color: #701703;
    background: url("?service=resource&name=warning.png&v=3.70.1") no-repeat left top;
}
div.wirismessage.wiriswarning {
    color: #70370a;
    background: url("?service=resource&name=warning2.png&v=3.70.1") no-repeat left top;
}
div.wirismessage.wirisinfo {
    color: #265970;
    background: url("?service=resource&name=warning3.png&v=3.70.1") no-repeat left top;
}
...
ul.wiristestassertionslist span.wiriscorrect {
    background: url("?service=resource&name=correct.gif&v=3.70.1") no-repeat left;
}

ul.wiristestassertionslist span.wirisincorrect {
    background: url("?service=resource&name=incorrect.gif&v=3.70.1") no-repeat left;
}

ul.wiristestassertionslist span.wirispartiallycorrect {
    background: url("?service=resource&name=percent.gif&v=3.70.1") no-repeat left;
}
...
input.wirisembeddedmathinput,
img.wirisembeddedmathinput {
    background: #fff url("?service=resource&name=editor16.png&v=3.70.1") no-repeat;
}
input.wirisembeddedauthoringfield,
img.wirisembeddedauthoringfield {
    background: #fff url("?service=resource&name=studio16.png&v=3.70.1") no-repeat;
}

input.wirisembeddedstudioinput,
img.wirisembeddedstudioinput,
span.wirisembeddedstudioinput {
    background: #fff url("?service=resource&name=studio24.png&v=3.70.1") no-repeat;
}
input.wirisembeddedstudioinput,
img.wirisembeddedstudioinput {
...
div.wirisanswerfielddecoration.wiriseditordecoration.wiriscorrect div.wiriseditorwrapper {
    background-image: url("?service=resource&name=correct.gif&v=3.70.1");
}
...
div.wirisanswerfielddecoration.wiriseditordecoration.wirisincorrect div.wiriseditorwrapper {
    background-image: url("?service=resource&name=incorrect.gif&v=3.70.1");
}
...
div.wirisanswerfielddecoration.wiriseditordecoration.wirispartiallycorrect div.wiriseditorwrapper {
    background-image: url("?service=resource&name=percent.gif&v=3.70.1");
}
...
.wirisfillwithcorrectbutton {
    background: url("?service=resource&name=uparrow24b.png&v=3.70.1");
}
.wirisrefreshbutton {
    background: url("?service=resource&name=refresh24b.png&v=3.70.1");
}
...
div.wiristabs fieldset.wirisfieldset legend a.wirisexpanded.wirisrevealcalclauncher {
    padding-left: 0;
    padding-right: 14px;
    background: url("?service=resource&name=fieldset-expanded.png&v=3.70.1") no-repeat right 50%;
}

div.wiristabs fieldset.wirisfieldset legend a.wiriscollapsed.wirisrevealcalclauncher {
    padding-left: 0;
    padding-right: 14px;
    background: url("?service=resource&name=fieldset-collapsed.png&v=3.70.1") no-repeat right 50%;
}
...
div.wiriscalcquizzescontainer {
    ...
    top: 48px;
    width: 100%;
    background: url("?service=resource&name=loading.gif&v=3.70.1") no-repeat center center;
    z-index: 100;
}
