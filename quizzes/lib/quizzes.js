...
com.wiris.quizzes.JsCasJnlpLauncher.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	...
	,sessionReceived: function(session) {
		...
		if(this.sessionState == com.wiris.quizzes.JsCasJnlpLauncher.STATE_NOT_FOUND) this.setButtonEnabled(true); else if(this.sessionState == com.wiris.quizzes.JsCasJnlpLauncher.STATE_NEW) {
			...
			haxe.Log.trace(session.get("error"),{ fileName : "JsComponent.hx", lineNumber : 1563, className : "com.wiris.quizzes.JsCasJnlpLauncher", methodName : "sessionReceived"});
		}
	}
...
com.wiris.quizzes.JsStudio.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	...
	,updateTolerancePrecisionWarnings: function(name,question) {
		...
		if(name == "wiriscassession" || name == com.wiris.quizzes.impl.Assertion.CHECK_PRECISION || name == com.wiris.quizzes.api.QuizzesConstants.OPTION_RELATIVE_TOLERANCE || name == com.wiris.quizzes.api.QuizzesConstants.OPTION_FLOAT_FORMAT || name == com.wiris.quizzes.api.QuizzesConstants.OPTION_PRECISION) {
			...
			if(parameters != null) {
				if(aname == com.wiris.quizzes.impl.Assertion.CHECK_PRECISION) {
					...
					while(_g3 < _g2) {
						var j1 = _g3++;
						h.text(" ");
						h.input("text","wirisassertionparam" + unique + "[" + aname + "][" + parameters[j1] + "]" + answers,null,null,null,null);
					}
				}
			}
			h.close();
