...
com.wiris.quizzes.JsAlgorithmInput = $hxClasses["com.wiris.quizzes.JsAlgorithmInput"] = function(d,v,library,delayload,languageLabel,buttonText,helpText,useCalc) {
	...
	this.setValue(v);
	if(this.useCas && !delayload) this.buildCasApplet(d);
...
com.wiris.quizzes.JsAlgorithmInput.prototype = $extend(com.wiris.quizzes.JsInput.prototype,{
	...
	,init: function() {
		var _g = this;
		if(this.useCas && this.applet == null && this.casJnlpLauncher == null) this.buildCasApplet(this.getOwnerDocument());
...
com.wiris.quizzes.JsCalcLauncher = $hxClasses["com.wiris.quizzes.JsCalcLauncher"] = function(d,v,text,buttonText,warningText,hide,lang) {
	...
	if(warningText != null && warningText.length > 0) {
		...
		this.warningContainer.innerHTML = "<span style=\"font-weight:bold\">" + this.t("calcWarning") + ":</span> " + warningText;
